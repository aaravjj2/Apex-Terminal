/**
 * Canonical demo data (duplicate for Apex-Terminal-main copy)
 * Keep identical to `frontend/src/ui2/demo/canonicalDemo.ts` so both shells use
 * the same single-source-of-truth for UI demo values.
 */
