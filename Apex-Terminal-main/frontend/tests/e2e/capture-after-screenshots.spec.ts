...
const SCREENSHOTS_DIR = 'C:\\Tradingview recreation\\artifacts\\proof\\v1-51-52-uiux\\screenshots_after';

test.describe('AFTER Screenshots - v1.51-52 UI Redesign', () => {
  test.setTimeout(300000); // 5 minutes timeout

  test('Capture comprehensive AFTER screenshots', async ({ page }) => {
    const errors: string[] = [];
    ...
    console.log(`Total AFTER screenshots captured: ${screenshotCount}`);
