# APEX Terminal Tour v1.11 — Full Walkthrough Guide
...
- Backtest Lab (top-level tool): configuration, run, analysis, comparison, and export
...
- Top navigation: Dashboard, Options, Backtest
...
### 02:00–03:00 — Options → Strategy Lab
...
### 03:00–05:30 — Backtest Lab (Top-Level Tool)
...
- **Backtest (top-level)**: Configure, run, analyze (5 charts), compare, export
- **Offline Reports**: Compliance-ready HTML exports
- **Deterministic Operation**: DEMO mode = zero network calls, reproducible results
- **Zero test failures**: TypeScript ✓, Vitest ✓, Pytest ✓, Playwright ✓
