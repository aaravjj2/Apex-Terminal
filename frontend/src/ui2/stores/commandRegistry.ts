...
export const COMMAND_REGISTRY: RegistryCommand[] = [
  ...
  { id: 'nav-research-agent', label: 'Research Agent', description: '4-node LLM-free state machine — OSI, BSM, FinBERT, Conformal PID', icon: 'R', category: 'navigation', keywords: ['research', 'agent', 'osi', 'black-scholes', 'finbert', 'conformal', 'spci'], path: '/ui2/research-agent' },
  { id: 'nav-command-center', label: 'Command Center', description: 'HITL pipeline review + agent swarm monitoring', icon: 'C', category: 'navigation', keywords: ['command', 'center', 'hitl', 'pipeline', 'tcc', 'mirofish', 'kronos'], path: '/ui2/command-center' },
