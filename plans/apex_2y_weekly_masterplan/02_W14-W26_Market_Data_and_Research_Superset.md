# Apex Terminal 2-Year Weekly Plan - Block 2 (Weeks 14-26)

**Time Window:** Weeks 14-26
**Block Theme:** Market data and research superset
...
## Week 14: Instrument master launch

### A. Weekly Mission and Scope
- Mission: deliver `Instrument master launch` with end-to-end readiness across frontend, backend, data, and operations.
...
## Week 15: Cross-asset quote API

### A. Weekly Mission and Scope
- Mission: deliver `Cross-asset quote API` with end-to-end readiness across frontend, backend, data, and operations.
- Scope includes one major UX lane, one backend contract lane, one data-quality lane, and one reliability lane.
- Exit requires production-grade evidence, not just feature completion.
...
## Week 16: Corporate actions ingestion

### A. Weekly Mission and Scope
- Mission: deliver `Corporate actions ingestion` with end-to-end readiness across frontend, backend, data, and operations.
- Scope includes one major UX lane, one backend contract lane, one data-quality lane, and one reliability lane.
- Exit requires production-grade evidence, not just feature completion.
...
## Week 17: Economic calendar service

### A. Weekly Mission and Scope
- Mission: deliver `Economic calendar service` with end-to-end readiness across frontend, backend, data, and operations.
- Scope includes one major UX lane, one backend contract lane, one data-quality lane, and one reliability lane.
- Exit requires production-grade evidence, not just feature completion.
...
## Week 18: News enrichment graph

### A. Weekly Mission and Scope
- Mission: deliver `News enrichment graph` with end-to-end readiness across frontend, backend, data, and operations.
- Scope includes one major UX lane, one backend contract lane, one data-quality lane, and one reliability lane.
- Exit requires production-grade evidence, not just feature completion.
...
## Week 19: Entity resolution pipeline

### A. Weekly Mission and Scope
- Mission: deliver `Entity resolution pipeline` with end-to-end readiness across frontend, backend, data, and operations.
- Scope includes one major UX lane, one backend contract lane, one data-quality lane, and one reliability lane.
- Exit requires production-grade evidence, not just feature completion.
...
## Week 20: Theme clustering engine

### A. Weekly Mission and Scope
- Mission: deliver `Theme clustering engine` with end-to-end readiness across frontend, backend, data, and operations.
- Scope includes one major UX lane, one backend contract lane, one data-quality lane, and one reliability lane.
- Exit requires production-grade evidence, not just feature completion.
...
## Week 21: Research notebook workflows

### A. Weekly Mission and Scope
- Mission: deliver `Research notebook workflows` with end-to-end readiness across frontend, backend, data, and operations.
- Scope includes one major UX lane, one backend contract lane, one data-quality lane, and one reliability lane.
- Exit requires production-grade evidence, not just feature completion.
...
## Week 22: BQL-like query builder

### A. Weekly Mission and Scope
- Mission: deliver `BQL-like query builder` with end-to-end readiness across frontend, backend, data, and operations.
- Scope includes one major UX lane, one backend contract lane, one data-quality lane, and one reliability lane.
- Exit requires production-grade evidence, not just feature completion.
...
## Week 23: Search ranking explainability

### A. Weekly Mission and Scope
- Mission: deliver `Search ranking explainability` with end-to-end readiness across frontend, backend, data, and operations.
- Scope includes one major UX lane, one backend contract lane, one data-quality lane, and one reliability lane.
- Exit requires production-grade evidence, not just feature completion.
...
## Week 24: Saved screeners and monitors

### A. Weekly Mission and Scope
- Mission: deliver `Saved screeners and monitors` with end-to-end readiness across frontend, backend, data, and operations.
- Scope includes one major UX lane, one backend contract lane, one data-quality lane, and one reliability lane.
- Exit requires production-grade evidence, not just feature completion.
...
## Week 25: Analyst collaboration toolkit

### A. Weekly Mission and Scope
- Mission: deliver `Analyst collaboration toolkit` with end-to-end readiness across frontend, backend, data, and operations.
- Scope includes one major UX lane, one backend contract lane, one data-quality lane, and one reliability lane.
- Exit requires production-grade evidence, not just feature completion.
...
## Week 26: Research QA and governance

### A. Weekly Mission and Scope
- Mission: deliver `Research QA and governance` with end-to-end readiness across frontend, backend, data, and operations.
- Scope includes one major UX lane, one backend contract lane, one data-quality lane, and one reliability lane.
- Exit requires production-grade evidence, not just feature completion.
